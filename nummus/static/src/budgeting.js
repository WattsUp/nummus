...
const budgeting = {
  ...
  //   budgeting.staticItems = Array.from(budgeting.staticItems).filter((e) => {
  ...
  //         return false;
  //       }
  //       if (e.matches(".budget-group-toggle-label") && firstGroupLabel) {
  ...
  //   if (budgeting.isGroup) {
  //     document.querySelector("#budget-temp-group").append(budgeting.dragItem);
  //     budgeting.trash.classList.remove("hidden");
  //   } else {
  //     document.querySelector("#budget-temp-row").append(budgeting.dragItem);
  //   }
  //
  ...
  //   const dragItemY =
  //     event.clientY -
  //     budgeting.mouseOffsetY -
  //     budgeting.dragItemHeight / 2 +
  //     scrollY;
  //
  //   if (
  //     budgeting.isGroup &&
  //     event.clientX >= budgeting.trashRect.left &&
  ...
  //   }
  //
  //   budgeting.dragItem.style.transform = `translate(${offsetX}px, ${offsetY}px)`;
  //
  //   budgeting.staticItems.forEach((e, i) => {
  ...
  //       invalid = true;
  //       document
  //         .querySelectorAll(".budget-group:not(.dragging)")
  //         .forEach((e) => {
  //           const group = e.closest(".budget-group");
  //           const groupChange = group.getAttribute("reorder") || null;
  //
  //           if (groupChange != null && groupChange != lastChange) {
  //             group.parentNode.insertBefore(budgeting.dragItem, group);
  //             invalid = false;
  //           }
  //
  ...
  //       let wasMoved = false;
  //       document.querySelectorAll(".budget-row:not(.dragging)").forEach((e) => {
  //         const group = e.closest(".budget-group");
  //         const groupHeader = group.querySelector(".budget-group-header");
  //         const rowChange = e.getAttribute("reorder") || null;
  //         const groupChange = groupHeader.getAttribute("reorder") || null;
  ...
  //             );
  //             let nextGroupHeader =
  //               nextGroup && nextGroup.querySelector(".budget-group-header");
  //             if (nextGroup && nextGroupHeader.getAttribute("reorder")) {
  ...
  //         const ungroupHeader = ungroup.querySelector(".budget-group-header");
  //         const ungroupChange = ungroupHeader.getAttribute("reorder") || null;
  //
  //         if (ungroupChange) {
  //           let nextGroup = lastGroup.parentNode.querySelector(
  //             `#${lastGroup.id} + .budget-group`,
  ...
  //         } else {
  //           document
  //             .querySelector("#budget-group- > .budget-group-fold")
  //             .append(budgeting.dragItem);
  //         }
  //       }
  //     }
  ...
  //         budgeting.dragItem,
  //         budgeting.dragItemSibling,
  //       );
  //     } else {
  //       // Add group input on each row
  //       anyMoved =
  //         budgeting.dragItemGroup !=
  ...
  //   } else {
  //     document
  //       .querySelectorAll(".budget-row input[name=group]")
  //       .forEach((e) => {
  //         e.remove();
  //       });
  //   }
  ...
  //   const target = event.target;
  //   if (target.matches("input, .budget-group-handle, .budget-group-handle *")) {
  //     return;
  //   }
  ...
  //   const buttons = document.querySelector("#budget-buttons");
  //   const status = document.querySelector("#budget-buttons-status");
  //   const newTxn = document.querySelector("#budget-new-txn");
  ...
  //   } else {
  //     status.innerHTML =
  //       toGo > 0 ? `Assign $${toGo.toFixed(2)} more to reach your target` : "";
  //
  ...
  //   if (!event || !event.target.matches(".budget-amount, .budget-amount *")) {
  ...
  onClickCategory(e, evt) {
    ...
    if (!e) {
      if (
        this.currentURI &&
        (!evt || !event.target.matches(".budget-category, .budget-category * "))
      ) {
