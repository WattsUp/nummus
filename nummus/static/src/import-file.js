...
const importFile = {
    ...
    xhrLoadStart: function(evt) {
        const file =
            document.querySelector('#import-form>input[type=file]').value;
        if (file) {
            document.querySelector('#import-upload-progress')
                .classList.remove('hidden');
        }
    },
    xhrProgress: function(evt) {
        document.querySelector('#import-upload-progress>progress')
