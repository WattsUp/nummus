...
class TestUnlock(TestBase):
    def test_unlock_unencrypted(self) -> None:
        ...
        original_get_pass = unlock_.utils.getpass.getpass
        ...
        try:
            ...
            unlock_.utils.getpass.getpass = mock_input  # type: ignore[attr-defined]
            ...
            unlock_.utils.getpass.getpass = original_get_pass
